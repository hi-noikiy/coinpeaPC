...
import {userInfo,   ClosePhone as close, closeGetPhonecode} from '../../../api/personal';
                    ...
                    <Form>
                        ...
                        >
                        {
                            getFieldDecorator('newPwd', {
                                rules: [
                                    { required: false, whitespace: true, message: intl.get('PW_MSG_TY4') },
